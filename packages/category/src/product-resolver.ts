...
const PRODUCT_TYPE_KEYWORDS: { type: string; terms: string[] }[] = [
  { type: "신발", terms: ["sneaker", "sneakers", "trainer", "trainers", "shoe", "shoes", "boot", "boots", "sandal", "sandals"] },
  { type: "가방", terms: ["backpack", "bag", "bags", "tote", "satchel", "pouch"] },
  { type: "모자", terms: ["hat", "hats", "beanie", "cap", "caps"] },
  { type: "원피스", terms: ["dress", "dresses"] },
  { type: "티셔츠", terms: ["t-shirt", "tshirt", "tee"] },
  { type: "아우터", terms: ["jacket", "coat", "parka", "outerwear"] },
  { type: "니트", terms: ["sweater", "jumper", "knit", "cardigan"] },
  { type: "바지", terms: ["pants", "trousers", "jeans", "leggings"] },
  { type: "스커트", terms: ["skirt"] },
  { type: "수영복", terms: ["swimwear", "swimsuit", "bikini"] },
  { type: "완구", terms: ["toy", "toys", "game", "puzzle"] },
  { type: "장난감", terms: ["plush", "stuffed animal"] },
];
